...
export class FornecedorFormComponent implements OnInit {
  ...
  constructor(private FornecedorFormService: FornecedorFormService, //servico do form
  ...
  insertSupplier(): void {
    ...
    this.FornecedorFormService.postNewSupplier(JSON.stringify(this.supplier)) //grava o novo fornecedor
      .pipe(first())
      .subscribe(() => {
  ...
  fields: Array<PoDynamicFormField> = [
    ...
    },
    {
      ...
      options: [
        { label: 'Grande Contribuinte', value: '1' },
        { label: 'Consumidor Final', value: '2' },
        { label: 'Exterior', value: '3' },
        { label: 'Taxa Zero Z.Franca', value: '4' },
        { label: 'Taxa Zero Ext', value: '5' },
